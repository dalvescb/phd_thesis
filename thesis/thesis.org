#+TITLE: Analysis of Compiler Heuristics via Stochastic Scheduling
...
* COMMENT TODOS                                                      :ignore:
  - add section spilling
  - when spilling can be beneficial for modulo scheduling
