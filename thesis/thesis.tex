...
\hypersetup{
 ...
 pdftitle={Analysis of Compiler Heuristics via Stochastic Scheduling},
 pdfkeywords={},
 pdfsubject={Ph.D Thesis by Curtis D'Alves; McMaster University},
...
\def\mytitle{{\sc PhD Thesis \hspace{12em} \color{grey}{.} }}
...
\label{sec:org5d9005e}
TODO summarize introduction
\section{Background to Instruction Scheduling}
\label{sec:org749bf7e}
...
\subsection{Types of Instruction Scheduling}
\label{sec:org811d46d}
...
\subsection{Combining Register Allocation and Instruction Scheduling}
\label{sec:org4abe947}
...
\subsection{Modulo Scheduling: Staging}
\label{sec:orgb31edeb}
\begin{figure}[htbp]
\centering
...
\subsection{Register Pressure In Staged Loops}
\label{sec:org04806c8}
...
\subsection{Register Remapping/Renaming}
\label{sec:orgc721f0c}
...
\section{Current State of the Art and Notable/Relevant Works in Instruction Scheduling}
\label{sec:org7837437}
\subsection{List Scheduling (most commonly performed scheduling)}
\label{sec:org75892ef}
...
\subsection{Meta-Optimization / Hyper-Heuristics}
\label{sec:org9bb3ea6}
...
\chapter{Coconut (Code Construction User Tool)}
\label{sec:orgbc1d9f6}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/coconut.png}
\caption{\label{fig:Coconut}Coconut}
\end{figure}
\section{Coconut Embedded Domain Specific Language}
\label{sec:org0ab716a}

Performance critical assembly code can be encoded in the Coconut \textbf{DSL}
TODO
\def\mytitle{{\sc Example Core Domain Specific Language Declaration \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
class CoreISA r where
    ...
    ...
\end{minted}
\subsection{One piece of code, a lot of functionality}
\label{sec:org4964f8b}
We can write SSA (Single-Static-Assignment) form basic blocks in our DSL, for example

\def\mytitle{{\sc Sample Basic Block In Coconut DSL \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\label{sec:orgd2feecc}
TODO
\subsection{Interpretation}
\label{sec:org3164c11}
TODO
\subsection{Simulation}
\label{sec:orgbaa6fa1}
TODO
\section{Tagged Data Flow Graphs}
\label{sec:org75120c3}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{figures/DAG.png}
\caption{\label{fig:DataFlowGraph}Sample Data Flow Graph}
\end{figure}

TODO describe the "tagged" input output 

Basic blocks are encoded as Data Flow Graphs with tagged inputs/outputs
\def\mytitle{{\sc Tagged Data Flow Graph Data Structure \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\def\mytitle{{\sc Sample DSL Code \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
f :: CoreISA r =>
  r GPR -> r GPR -> (r GPR,r GPR)
f x y =
...
\def\mytitle{{\sc Sample Tagged Data Flow Graph \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\subsection{Data Flow Graph Combinators}
\label{sec:orgf466b39}
...
\def\mytitle{{\sc Data Flow Graph Composition \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\def\mytitle{{\sc Data Flow Graph Decomposition \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\subsection{Case Study: Software Pipelining}
\label{sec:org583704a}
Partition the data flow graph by stage
\def\mytitle{{\sc Software Pipelining using Combinator API \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
numStages   :: Int
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.3\textwidth]{controlflow.png}
\caption{\label{fig:ControlFlowGraph}Control Flow Graph}
\end{figure}


\subsection{Type Safe Control Flow API}
\label{sec:orgc1f6c1e}
...
\def\mytitle{{\sc Block Construction API \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
-- | Generate a @Block@
...
\def\mytitle{{\sc Unwrappable Type Class \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\def\mytitle{{\sc Type Safe Control Flow Interface \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\end{minted}
\subsection{Unsafe Control Flow Interface}
\label{sec:orgf7826c8}
...
\def\mytitle{{\sc UnSafe Control Flow Interface \hspace{12em} \color{grey}{.} }}
\begin{minted}[]{haskell}
...
\label{sec:org01e9afb}
TODO discuss implementation details of code graph construction
\subsection{Detection of sharing in EDSL}
\label{sec:org601e3f9}
TODO discuss scaling issues due to not implicit detection of sharing

\chapter{Stochastic Scheduling Model}
\label{sec:org9ca27dd}
...
\section{Linear Vs Non-Linear Model}
\label{sec:org4f125cb}
TODO show how linear model can span the same space of schedules as non-linear

\chapter{Analysis of Schedule Space}
\label{sec:org75c6b31}
TODO

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{figures/DistributionStochasticSchedules.png}
\caption{\label{fig:DistributionStochastic}Distribution Stochastic Schedules}
\end{figure}

\chapter{Opportunity for Hyper-Heuristic Development}
\label{sec:orgdfd01eb}
...
\chapter{Conclusion}
\label{sec:orgb982c0a}
TODO
\addcontentsline{toc}{part}{thesis}
\printbibliography
\end{document}