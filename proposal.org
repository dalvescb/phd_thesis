...
* Introduction (Background)
  ...
  instructions. Furthermore, resource constraints such as the number of
  available registers and functional units can also delay execution. This
  creates an interesting problem for hardware and/or compilers, selecting a
...
scheduling problems are given by either:
    - *Heuristics* most commonly used by conventional compilers
