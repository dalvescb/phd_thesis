...
** Spilling
  ...
  \parencite{Chaitin:1982:RAS:872726.806984}. The choice of which node to spill
  is a cost/benefit estimation. Each edge in the interference graph can be
  assigned an estimated live range (how long the edge is in the resulting
  schedule). Eliminating longer live ranges alleviates more register pressure
  and creates a more flexible scheduling space.
