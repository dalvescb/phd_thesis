...
** SuperScalar Architectures
   ...
   often not sufficient to allow generation of code that utilizes machine
   resources to the desired extent \parencite{bernstein1991global}. 
   
   Both of the above figures [[fig:PipelinedArchitecture]] and
   [[fig:SuperScalarArchitecture]] show an ideal schedule with no stalls.
