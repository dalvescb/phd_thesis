...
** Modulo Scheduling: Staging
   Module scheduling focuses on exploiting instruction level parallelism within
   loops by interleaving successive iterations of the loop and executing them in
   parallel.
