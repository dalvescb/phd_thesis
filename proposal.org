...
** Register Allocation via Graph Coloring
   ...
   operate on graphs, were generally the objects are vertices and edges denote
   connected vertices cannot be in the same class. Classes are represented via
   colors, and a *k-coloring* denotes a partitioning into k distinct classes.
